...
public class RotateToDegrees extends  Command {
	...
	protected void execute() {
		...
		if(speed * speedModifier > RobotMap.GYRO_ROTATE_MAX_SPEED)
			speed = RobotMap.GYRO_ROTATE_MAX_SPEED * speedModifier;
		else if (speed * speedModifier < RobotMap.GYRO_ROTATE_MIN_SPEED)
			speed = RobotMap.GYRO_ROTATE_MIN_SPEED * speedModifier;
